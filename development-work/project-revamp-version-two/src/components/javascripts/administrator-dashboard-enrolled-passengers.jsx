...
const contractAddress = '0xfc45804B1f337Bb2AD9266E1e2e454F2cb635562';
          ...
          <div className='administrator-dashboard-requests-navbar' style={{backgroundColor:"#FFFFFF",width:"97.75vw", height:"10vh", display:"flex", flexDirection:"row", textAlign:"center", borderRadius:"20px 20px 0px 0px", paddingLeft:"1vh", paddingTop:"1vh"}}>
           ...
           <div style={{display:"flex", flexDirection:"row"}}>
             ...
             <div style={{border:"1px black solid",marginLeft:"2vw", width:"47vw", maxHeight:"80vh",height:"80vh", marginRight:"2vw",overflow:"scroll"}}>
               {showPassengerDetails &&(<div style={{backgroundColor:"#FEFEFA",margin:"1vh",height:"90vh"}}>
               ...
               <div style={{display:'flex',flexDirection:'column',alignSelf:'center'}}>
                 ...
                 <tbody>
                   ...
                   <table style={{width:'50vw'}}>
                    ...
                    <tr style={{height:"1vh"}}>
                      <td style={{width:"10vw",textAlign:'center'}}>{passengers[selectedPassID-1].PassVehicleName}</td>
                      <td style={{width:"10vw",textAlign:'center'}}>{passengers[selectedPassID-1].PassVehicleNumber}</td>
                      <td style={{width:"10vw",textAlign:'center'}}><button disabled={!(passengers[selectedPassID-1].PassVehicleDetailsHash)}
  onClick={(event) => {
