...
>
  View Vehicle Papers
                    ...
                    {userDetails[6] == 1 && (
                        ...
                        <h4 style={{textAlign:'left',color:"#03C988",fontWeight:"700", fontSize:"larger"}}>APPROVED</h4>
                        </div>
                      )}
                      {userDetails[6]== 2 && (
                        <div style={{border:"2px solid #000000",width:"20vw",height:'5vh',marginTop:'2vh',marginLeft:'2vw'}}>
                          <h4 style={{textAlign:'left',color:"#F24C3D",fontWeight:"700", fontSize:"larger"}}>REJECTED</h4>
